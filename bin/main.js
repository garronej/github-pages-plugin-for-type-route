...
var pathToRouterJs = path_1.join(buildDir, pathToRouterTs.replace(/ts$/i, "js").split(path_1.sep).slice(1).join(path_1.sep));
...
st.execSync("cp " + indexHtmlPath + " " + path_1.join(buildDir, "404.html"));
